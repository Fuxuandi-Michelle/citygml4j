...
public class Buildingx extends AbstractBuilding {
	...
	public Buildingx(BuildingModule module) {
		super(module);
	}
	...
	public Object copy(CopyBuilder copyBuilder) {
		return copyTo(new Buildingx(), copyBuilder);
	}

	@Override
	public Object copyTo(Object target, CopyBuilder copyBuilder) {
		Buildingx copy = (target == null) ? new Buildingx() : (Buildingx)target;
