...
public class Beam extends BuildingInstallation implements BuildingExtraModuleComponent {
	...
	public Beam(BuildingExtraModule module) {
		this.module = module;
	}
	
	
	public CityGMLClass getCityGMLClass() {
		return CityGMLClass.BEAM;
	}
	
	public Object copy(CopyBuilder copyBuilder) {
		return copyTo(new Beam(), copyBuilder);
	}

	@Override
	public Object copyTo(Object target, CopyBuilder copyBuilder) {
		Beam copy = (target == null) ? new Beam() : (Beam)target;
