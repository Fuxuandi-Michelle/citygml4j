...
public class FlowTerminal extends BuildingInstallation implements BuildingExtraModuleComponent {
	...
	public FlowTerminal(BuildingExtraModule module) {
		this.module = module;
	}
	
	
	public CityGMLClass getCityGMLClass() {
		return CityGMLClass.FLOW_TERMINAL;
	}
	
	public Object copy(CopyBuilder copyBuilder) {
		return copyTo(new FlowTerminal(), copyBuilder);
	}

	@Override
	public Object copyTo(Object target, CopyBuilder copyBuilder) {
		FlowTerminal copy = (target == null) ? new FlowTerminal() : (FlowTerminal)target;
