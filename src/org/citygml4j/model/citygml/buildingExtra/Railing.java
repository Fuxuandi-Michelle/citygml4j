...
public class Railing extends BuildingInstallation implements BuildingExtraModuleComponent {
	...
	public Railing(BuildingExtraModule module) {
		this.module = module;
	}
	
	
	public CityGMLClass getCityGMLClass() {
		return CityGMLClass.RAILING;
	}
	
	public Object copy(CopyBuilder copyBuilder) {
		return copyTo(new Railing(), copyBuilder);
	}

	@Override
	public Object copyTo(Object target, CopyBuilder copyBuilder) {
		Railing copy = (target == null) ? new Railing() : (Railing)target;
