...
public class Stair extends BuildingInstallation implements BuildingExtraModuleComponent {
	...
	public Stair(BuildingExtraModule module) {
		this.module = module;
	}
	
	
	public CityGMLClass getCityGMLClass() {
		return CityGMLClass.STAIR;
	}
	
	public Object copy(CopyBuilder copyBuilder) {
		return copyTo(new Stair(), copyBuilder);
	}

	@Override
	public Object copyTo(Object target, CopyBuilder copyBuilder) {
		Stair copy = (target == null) ? new Stair() : (Stair)target;
