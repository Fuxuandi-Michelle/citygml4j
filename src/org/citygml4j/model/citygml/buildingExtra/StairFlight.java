...
public class StairFlight  extends BuildingInstallation implements BuildingExtraModuleComponent {
	...
	public StairFlight(BuildingExtraModule module) {
		this.module = module;
	}
	
	
	public CityGMLClass getCityGMLClass() {
		return CityGMLClass.STAIR_FLIGHT;
	}
	
	public Object copy(CopyBuilder copyBuilder) {
		return copyTo(new StairFlight(), copyBuilder);
	}

	@Override
	public Object copyTo(Object target, CopyBuilder copyBuilder) {
		StairFlight copy = (target == null) ? new StairFlight() : (StairFlight)target;
